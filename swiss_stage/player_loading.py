...
def _compute_best_role_major_minor(roles_obj) -> tuple[float, float]:
    """
...
def _compute_boosters_list(boosters_obj, top_k: int = 5) -> List[float]:
    """
...
def load_team_players(team_id: int) -> Dict[int, PlayerState]:
    ...
    try:
        ...
        for pid in player_ids:
            ...
            major_pct, minor_pct = _compute_best_role_major_minor(roles_obj)
            boosters_list = _compute_boosters_list(boosters_obj, top_k=5)
